<?php
/*
Plugin Name: Bestwebsite Admin Page
Plugin URI: http://bestwebsite.com
Description: Bestwebsite WP Admin Page
Version: 1.0
Author: Bestwebsite
Author URI: https://github.com/bestwebsite/wp-admin-page
*/
   ...
   */
  $options_panel = new Bestwebsite_Admin_Page_Class($config);
